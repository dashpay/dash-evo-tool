...
5. **Reference implementation**: `impl From<SdkError> for TaskError` in `src/backend_task/error.rs` demonstrates the pattern for SDK errors. New `TaskError` variants should follow the same style.
