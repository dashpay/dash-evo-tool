pub mod json_store;
pub mod keystore;
use dash_sdk::{dpp::identity::signer::Signer, platform::IdentityPublicKey};
use std::fmt::Debug;
...
/// Secret (eg. a password) to use for unlocking the KMS.
...
pub trait Kms {
    ...
    fn get(&self, key: &Self::KeyHandle) -> Result<Option<PublicKey>, Self::Error>;
}
