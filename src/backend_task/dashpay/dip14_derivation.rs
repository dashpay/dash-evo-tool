...
mod tests {
    ...
    fn test_identifier_to_index_conversion() {
        let id_bytes = [
            0x77, 0x5d, 0x38, 0x54, 0xc9, 0x10, 0xb7, 0xde, 0xe4, 0x36, 0x86, 0x9c, 0x47, 0x24,
            0xbe, 0xd2, 0xfe, 0x07, 0x84, 0xe1, 0x98, 0xb8, 0xa3, 0x9f, 0x02, 0xbb, 0xb4, 0x9d,
            0x8e, 0xbc, 0xfc, 0x3b,
        ];
    ...
    fn test_dip14_test_vector_1() {
        ...
        let index1 =
            hex::decode("775d3854c910b7dee436869c4724bed2fe0784e198b8a39f02bbb49d8ebcfc3b")
                .unwrap();
        let index2 =
            hex::decode("f537439f36d04a15474ff7423e4b904a14373fafb37a41db74c84f1dbb5c89a6")
                .unwrap();
