        ...
        eframe::run_native(
            ...
            Box::new(|cc| {
                ...
                fonts.font_data.insert(
                    "noto_sans".to_owned(),
                    FontData::from_static(include_bytes!("../assets/Fonts/Noto_Sans/static/NotoSans-Light.ttf")).into(),
                );

                // Insert each regional font
                fonts.font_data.insert(
                    "noto_sans_sc".to_owned(),
                    FontData::from_static(include_bytes!("../assets/Fonts/Noto_Sans_SC/static/NotoSansSC-Light.ttf")).into(),
                );
                fonts.font_data.insert(
                    "noto_sans_tc".to_owned(),
                    FontData::from_static(include_bytes!("../assets/Fonts/Noto_Sans_TC/static/NotoSansTC-Light.ttf")).into(),
                );
                fonts.font_data.insert(
                    "noto_sans_jp".to_owned(),
                    FontData::from_static(include_bytes!("../assets/Fonts/Noto_Sans_JP/static/NotoSansJP-Light.ttf")).into(),
                );
                fonts.font_data.insert(
                    "noto_sans_kr".to_owned(),
                    FontData::from_static(include_bytes!("../assets/Fonts/Noto_Sans_KR/static/NotoSansKR-Light.ttf")).into(),
                );
                fonts.font_data.insert(
                    "noto_sans_thai".to_owned(),
                    FontData::from_static(include_bytes!("../assets/Fonts/Noto_Sans_Thai/static/NotoSansThai-Light.ttf")).into(),
                );
                fonts.font_data.insert(
                    "noto_sans_khmer".to_owned(),
                    FontData::from_static(include_bytes!("../assets/Fonts/Noto_Sans_Khmer/static/NotoSansKhmer-Light.ttf")).into(),
                );
                fonts.font_data.insert(
                    "noto_sans_arabic".to_owned(),
                    FontData::from_static(include_bytes!("../assets/Fonts/Noto_Sans_Arabic/static/NotoSansArabic-Light.ttf")).into(),
                );
                fonts.font_data.insert(
                    "noto_sans_hebrew".to_owned(),
                    FontData::from_static(include_bytes!("../assets/Fonts/Noto_Sans_Hebrew/static/NotoSansHebrew-Light.ttf")).into(),
                );
                fonts.font_data.insert(
                    "noto_sans_devanagari".to_owned(),
                    FontData::from_static(include_bytes!("../assets/Fonts/Noto_Sans_Devanagari/static/NotoSansDevanagari-Light.ttf")).into(),
                );

                // Define fallback chain for proportional text
                fonts.families.entry(FontFamily::Proportional).or_default().splice(.., vec![
                    "Ubuntu-Light".into(),
                    "noto_sans".to_owned(),
