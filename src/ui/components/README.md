...
| `accent_pill()` / `pending_username_pill()` | `pill.rs` | N/A (display) | Shared accent-badge renderer plus the DPNS-specific pending-name pill. `IdentityHeroCard` and Settings delegate their badges to these renderers. |
