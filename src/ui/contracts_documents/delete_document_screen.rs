...
pub struct DeleteDocumentScreen {
...
impl DeleteDocumentScreen {
    ...
    fn show_success_screen(&mut self, ui: &mut Ui) -> AppAction {
        ...
        ui.vertical_centered(|ui| {
            ...
            if ui.button("Delete Another").clicked() {
                self.reset_fields();
...
impl ScreenLike for DeleteDocumentScreen {
    ...
    fn ui(&mut self, ctx: &Context) -> AppAction {
        let mut action = add_top_panel(
            ...
            vec![
                ...
                ("Delete Document", AppAction::None),
            ],
            vec![],
        );
        ...
        egui::CentralPanel::default().show(ctx, |ui| {
            ...
            let button = egui::Button::new(RichText::new("Delete document").color(Color32::WHITE))
                ...
                match self.parse_doc_id() {
                    Ok(doc_id) => {
                        ...
                        let token_payment_info =
                            if let Some(token_cost) = doc_type.document_deletion_token_cost() {
...
impl ScreenWithWalletUnlock for DeleteDocumentScreen {
