...
impl RootScreenType {
    ...
    pub fn to_int(self) -> u32 {
        match self {
            ...
            RootScreenType::RootScreenSettings => 7,
    ...
    pub fn from_int(value: u32) -> Option<Self> {
        match value {
            ...
            7 => Some(RootScreenType::RootScreenSettings),
            // 8 used to be the Withdrawals Statuses screen
...
impl From<RootScreenType> for ScreenType {
    fn from(value: RootScreenType) -> Self {
        match value {
            ...
            RootScreenType::RootScreenSettings => ScreenType::Settings,
...
impl Screen {
    pub fn change_context(&mut self, app_context: Arc<AppContext>) {
        match self {
            ...
            Screen::SettingsScreen(screen) => screen.current_network = app_context.network,
...
impl Screen {
    pub fn screen_type(&self) -> ScreenType {
        match self {
            ...
            Screen::SettingsScreen(_) => ScreenType::Settings,
...
impl ScreenLike for Screen {
    fn refresh(&mut self) {
        match self {
            ...
            Screen::SettingsScreen(screen) => screen.refresh(),
    ...
    fn refresh_on_arrival(&mut self) {
        match self {
            ...
            Screen::SettingsScreen(screen) => screen.refresh_on_arrival(),
    ...
    fn ui(&mut self, ctx: &Context) -> AppAction {
        match self {
            ...
            Screen::SettingsScreen(screen) => screen.ui(ctx),
    ...
    fn display_message(&mut self, message: &str, message_type: MessageType) {
        match self {
            ...
            Screen::SettingsScreen(screen) => screen.display_message(message, message_type),
    ...
    fn pop_on_success(&mut self) {
        match self {
            ...
            Screen::SettingsScreen(screen) => screen.pop_on_success(),
