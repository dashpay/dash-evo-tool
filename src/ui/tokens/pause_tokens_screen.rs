...
impl PauseTokensScreen {
    ...
    fn build_pause_task(base: &mut TokenOperationBase) -> AppAction {
...
impl ScreenLike for PauseTokensScreen {
    ...
    fn display_task_result(&mut self, backend_task_success_result: BackendTaskSuccessResult) {
        if let BackendTaskSuccessResult::Token(TokenResult::PausedTokens(fee_result)) =
    ...
    fn ui(&mut self, ctx: &Context) -> AppAction {
        ...
        let central_panel_action = island_central_panel(ctx, |ui| {
            ...
            self.base.render_advanced_header(ui, "Pause");
            self.base.render_key_selection(ui, "Pause");
            self.base.render_public_note(ui, "Pause");
            ...
            if self.base.confirmation_dialog.is_some() {
                action |= self
                    .base
                    .show_confirmation_popup(ui, Self::build_pause_task);
            }

            self.base.render_status(ui, "Pausing");
