...
impl ResumeTokensScreen {
    ...
    fn render_key_selection(&mut self, ui: &mut Ui) {
        ui.horizontal(|ui| {
            ui.label("Select Key:");
            egui::ComboBox::from_id_salt("resume_key_selector")
    ...
    fn show_confirmation_popup(&mut self, ui: &mut Ui) -> AppAction {
        ...
        egui::Window::new("Confirm Resume")
            .collapsible(false)
            .open(&mut is_open)
            .show(ui.ctx(), |ui| {
                ui.label("Are you sure you want to resume normal token actions for this contract?");
                ui.add_space(10.0);
    ...
    fn ui(&mut self, ctx: &Context) -> AppAction {
        ...
        egui::CentralPanel::default().show(ctx, |ui| {
            ...
            if !has_keys {
                ...
                // If user pressed "Resume," show popup
